  ...
  return (
    <ReactLenis root options={{ autoRaf: false }} ref={lenisRef} >
      <main className="bg-black text-white overflow-x-hidden">
        ...
        {/* Shoes Showcase */}
        <section className="w-screen min-h-[200dvh] max-lg:min-h-[360dvh] py-20 px-6 md:px-12 lg:px-24">
          <div className="max-w-7xl mx-auto p-5">
            {/* Heading */}
            <h2
              className="collection-title text-5xl md:text-6xl font-black text-center mb-16 opacity-0"
            >
              Iconic Collection
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {shoes.map((shoe) => (
                <div
                  key={shoe.id}
                  className="shoe-card group relative bg-gray-900 rounded-2xl p-8 hover:bg-gray-800 
                     transition-all duration-500 h-[600px] will-change-transform will-change-opacity"
                >
                  ...
                  <button className="w-full bg-white text-black py-3 rounded-full font-bold hover:bg-gray-200 
